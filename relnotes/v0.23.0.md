...
* Cops are now namespace aware, which would it make it simpler to write RubbyCop extensions without
...
* The `Rubocop` module was renamed to `RubbyCop`, which will affect packages relying on RubbyCop's public API.
