    ...
    context 'when there are disabled lines' do
      context 'and there are no offenses' do
        ...
        context 'and a comment disables' do
          context 'one cop' do
            let(:source) { "# rubbycop:disable Metrics/MethodLength\n" }
            ...
            it 'returns an offense' do
              ...
              expect(cop.highlights)
                .to eq(['# rubbycop:disable Metrics/MethodLength'])
            end
          ...
          context 'an unknown cop' do
            let(:source) { '# rubbycop:disable UnknownCop' }
            let(:cop_disabled_line_ranges) do
            ...
            it 'returns an offense' do
              ...
              expect(cop.highlights)
                .to eq(['# rubbycop:disable UnknownCop'])
            end
          end

          context 'itself' do
            let(:source) { '# rubbycop:disable Lint/UnneededDisable' }
            let(:cop_disabled_line_ranges) do
          ...
          context 'itself and another cop' do
            context 'disabled on the same range' do
              let(:source) do
                '# rubbycop:disable Lint/UnneededDisable, Metrics/ClassLength'
              end
          ...
          context 'multiple cops' do
            let(:source) do
              '# rubbycop:disable Metrics/MethodLength, Metrics/ClassLength'
            end
            let(:cop_disabled_line_ranges) do
              { 'Metrics/ClassLength' => [1..Float::INFINITY],
                'Metrics/MethodLength' => [1..Float::INFINITY] }
          ...
          context 'multiple cops, and the leftmost one has no offenses' do
            let(:source) do
              '# rubbycop:disable Metrics/ClassLength, Metrics/MethodLength'
            end
            let(:cop_disabled_line_ranges) do
              { 'Metrics/ClassLength' => [1..Float::INFINITY],
                'Metrics/MethodLength' => [1..Float::INFINITY] }
          ...
          context 'multiple cops, with abbreviated names' do
            context 'one of them has offenses' do
              let(:source) do
                '# rubbycop:disable MethodLength, ClassLength, Debugger'
              end
              let(:cop_disabled_line_ranges) do
                { 'Metrics/ClassLength' => [1..Float::INFINITY],
                  'Metrics/MethodLength' => [1..Float::INFINITY],
          ...
          context 'comment is not at the beginning of the file' do
            context 'and not all cops have offenses' do
              let(:source) do
                ['puts 1',
                 '# rubbycop:disable MethodLength, ClassLength'].join("\n")
              end
              let(:cop_disabled_line_ranges) do
          ...
          context 'misspelled cops' do
            let(:source) do
              '# rubbycop:disable Metrics/MethodLenght, KlassLength'
            end
            let(:cop_disabled_line_ranges) do
          ...
          context 'all cops' do
            let(:source) { '# rubbycop:disable all' }
            let(:cop_disabled_line_ranges) do
              {
                'Metrics/MethodLength' => [1..Float::INFINITY],
                'Metrics/ClassLength' => [1..Float::INFINITY],
            ...
            it 'returns an offense' do
              ...
              expect(cop.highlights).to eq(['# rubbycop:disable all'])
            end
          end
        end
      end
        ...
        context 'and a comment disables' do
          context 'one cop twice' do
            ...
            it 'returns an offense' do
              ...
              expect(cop.highlights)
                .to eq(['# rubbycop:disable Style/ClassVars'])
            end
          end
      ...
      context 'and there is an offense' do
        ...
        context 'and a comment disables' do
          context 'that cop' do
            let(:source) { '# rubbycop:disable Layout/Tab' }
