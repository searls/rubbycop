...
describe RubbyCop::CLI, :isolated_environment do
  ...
  describe '--auto-gen-config' do
    ...
    it 'overwrites an existing todo file' do
      ...
      expect(IO.readlines('.rubbycop_todo.yml')[8..-1].map(&:chomp))
    ...
    it 'honors rubbycop:disable comments' do
      ...
      create_file('.rubbycop.yml', ['inherit_from: .rubbycop_todo.yml'])
      expect(cli.run(['--auto-gen-config'])).to eq(1)
      expect(IO.readlines('.rubbycop_todo.yml')[8..-1].join)
        .to eq(['# Offense count: 1',
                '# Cop supports --auto-correct.',
                'Layout/TrailingWhitespace:',
                '  Exclude:',
    ...
    it 'can generate a todo list' do
      ...
      expect($stdout.string)
        .to include(['Created .rubbycop_todo.yml.',
                     'Run `rubbycop --config .rubbycop_todo.yml`, or ' \
                     'add `inherit_from: .rubbycop_todo.yml` in a ' \
                     '.rubbycop.yml file.',
                     ''].join("\n"))
      expected =
        ['# This configuration was generated by',
         ...
         '# versions of RubbyCop, may require this file to be generated ' \
         'again.',
         '',
         '# Offense count: 1',
         '# Cop supports --auto-correct.',
         ...
         '  Exclude:',
         "    - 'example1.rb'"]
      actual = IO.read('.rubbycop_todo.yml').split($RS)
    ...
    it 'can generate Exclude properties with a given limit' do
      ...
      expected =
        ['# This configuration was generated by',
         '# `rubbycop --auto-gen-config --exclude-limit 1`',
         /# on .* using RubbyCop version .*/,
         '# The point is for the user to remove these configuration records',
         '# one by one as the offenses are removed from the code base.',
         '# Note that changes in the inspected code, or installation of new',
    ...
    it 'generates a todo list that removes the reports' do
      ...
      $stdout = StringIO.new
      result = cli.run(%w[--config .rubbycop_todo.yml --format emacs])
    ...
    it 'does not include offense counts when --no-offense-counts is used' do
      ...
      expected =
        ['# This configuration was generated by',
         '# `rubbycop --auto-gen-config --no-offense-counts`',
         /# on .* using RubbyCop version .*/,
         '# The point is for the user to remove these configuration records',
         '# one by one as the offenses are removed from the code base.',
         '# Note that changes in the inspected code, or installation of new',
