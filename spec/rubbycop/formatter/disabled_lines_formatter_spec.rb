      ...
      describe '#finished' do
        context 'when there disabled cops detected' do
          ...
          before do
            ...
            formatter.file_started('lib/rubbycop.rb', cop_disabled_line_ranges)
            formatter.file_finished('lib/rubbycop.rb', offenses)
          end
          ...
          it 'lists disabled cops by file' do
            ...
            expect(output.string)
              .to eq(<<-END.strip_indent)
                ...
                lib/rubbycop.rb:1..1: LineLength
                lib/rubbycop.rb:1..Infinity: ClassLength
              END
          end
        end
      end
