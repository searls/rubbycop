...
describe RubbyCop::Options, :isolated_environment do
  ...
  describe 'option' do
    describe '-h/--help' do
      ...
      it 'shows help text' do
        begin
          options.parse(['--help'])
        rescue SystemExit # rubbycop:disable Lint/HandleExceptions
        end

        expected_help = <<-END.strip_indent
          Usage: rubbycop [options] [file1, file2, ...]
  ...
  describe 'options precedence' do
    ...
    context '.rubbycop file' do
      before do
        create_file('.rubbycop', %w[--color --fail-level C])
      end
    ...
    context '.rubbycop directory' do
      before do
        FileUtils.mkdir '.rubbycop'
      end
    ...
    context 'RUBOCOP_OPTS environment variable' do
      ...
      it 'has higher precedence then options from .rubbycop file' do
        create_file('.rubbycop', %w[--color --fail-level C])
