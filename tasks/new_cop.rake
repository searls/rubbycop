...
task :new_cop, [:cop] do |_task, args|
      ...
      module Cop
        module #{badge.department}
          ...
          class #{badge.cop_name} < Cop
            ...
            # See. https://github.com/searls/rubbycop/blob/master/lib/rubbycop/node_pattern.rb
            #
            # For example
  ...
  cop_path = "lib/rubbycop/cop/#{to_snake(badge.to_s)}.rb"
  ...
  spec_path = "spec/rubbycop/cop/#{to_snake(cop_name)}_spec.rb"
  ...
  puts <<-END.strip_indent
    ...
    - Add `require '#{cop_path.gsub(/\.rb$/, '').gsub(%r{^lib/}, '')}'` into lib/rubbycop.rb
